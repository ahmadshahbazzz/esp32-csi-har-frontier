...
\begin{tikzpicture}[font=\footnotesize,text=txt,>={Triangle[length=2.4mm,width=2mm]},node distance=6mm,
  stg/.style={rounded corners=2pt,line width=0.7pt,align=center,inner sep=3pt,minimum height=13mm,minimum width=26mm},
...
\node[acq,right=30mm of ap] (rx) {\textbf{Wi-Fi RX +}\\\textbf{CSI callback}};
