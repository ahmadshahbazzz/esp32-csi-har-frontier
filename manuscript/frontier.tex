...
\textbf{This work} & \textbf{classic ESP32} & \textbf{classic ESP32} & \textbf{Y} & \textbf{Y} & \textbf{Y} & \textbf{classical+tiny+deep} & \textbf{int8+emlearn} & \textbf{N} & \textbf{8--54\,kB} & \textbf{9--321\,ms} & \textbf{INA219} \\
\bottomrule
\end{tabular}}
\end{table*}
