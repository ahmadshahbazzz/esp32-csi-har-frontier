...
LOUO & Leave-One-User-Out (subject-independent evaluation in which the test user is absent from training).\\
MCU & Microcontroller Unit.\\
ML & Machine Learning.\\
MLP & Multilayer Perceptron.\\
NPU & Neural Processing Unit.\\
PSRAM & Pseudo-Static Random-Access Memory (external RAM absent on the classic ESP32).\\
RF & Random Forest.\\
SIMD & Single Instruction, Multiple Data (vector kernels).\\
SoC & System on Chip.\\
