...
% TODO(author): verify CSI-Bench exact author list, arXiv ID, and year before submission.
\bibitem{csibench2024}
G. Zhu \emph{et al.}, ``CSI-Bench: A large-scale in-the-wild dataset for multi-task WiFi sensing,'' \emph{arXiv preprint}, 2025. [Online]. Available: \url{https://github.com/guozhenjennzhu/CSI-Bench}
