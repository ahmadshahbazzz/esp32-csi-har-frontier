...
\author{\uppercase{Muhammad Ahmad}\authorrefmark{1}}
\address[1]{Faculty of Information Technology, University of Central Punjab, Lahore, Pakistan (e-mail: muhammad.ahmad@ucp.edu.pk)}

\markboth
{Ahmad: How Far Can a PSRAM-less ESP32 Go? A TinyML Deployment Study for WiFi CSI HAR}
{Ahmad: How Far Can a PSRAM-less ESP32 Go? A TinyML Deployment Study for WiFi CSI HAR}

\corresp{Corresponding author: Muhammad Ahmad (e-mail: muhammad.ahmad@ucp.edu.pk).}
...
\midrule
Decision Tree (emlearn C) & UT-HAR & 0.0011 & $<$1 \\
Random Forest (emlearn C) & UT-HAR & 0.045  & $<$1 \\
...
\midrule
Deep tier (all)  & UT-HAR  & \multicolumn{2}{c}{does not allocate (arena $>$ 108\,kB or no conversion)} \\
\bottomrule
\end{tabular}
\end{table}
...
The author thanks the Faculty of Information Technology, University of Central Punjab, for support and computing resources.
...
M. Ahmad: conceptualization, methodology, software, validation, formal analysis, investigation, data curation, writing (original draft, review, and editing), and visualization.

\section*{Ethics Declaration}
This work involves only secondary analysis of publicly available, de-identified datasets and on-device latency and memory measurements. No experiments on human participants or animals were conducted by the author, so ethics approval was not required.
...
An AI assistant was used to help draft and edit code and prose. All experimental results, on-device measurements, and scientific claims were produced and verified by the author, who takes full responsibility for the content.
